...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.close = function (selector) {
  let counter = 0;
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttr = function (attrName) {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].getAttribute(attrName)) continue;
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleAttr = function (attrName, value) {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].getAttribute(attrName)) {
      this[i].setAttribute(attrName, value);
    } else this[i].removeAttribute(attrName);
  }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.click = function (handler) {
  for (let i = 0; i < this.length; i++) {
    if (handler) {
      ...
      this[i].click(); // вариант для виртуально клика
    }
  }
